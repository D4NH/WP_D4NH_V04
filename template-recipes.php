    ...
    <div id="intro" class="container">
      <div class="row intro">
        <div class="col-md-offset-3 col-md-6">
          <?php
            // The Query
            $the_query = new WP_Query( array( 'page_id' => 1370 ) );
              ...
              while ( $the_query->have_posts() ) {
                ...
                <div class="col-md-4">
                  ...
                  <div class="subsection">
                    ...
                    <div class="clock"><i class="fa fa-cutlery"></i> Recepten</div>
      ...
      <!-- <div class="row">
        <div class="col-md-12">
          <h2 class="sectiontitle">Snacks</h2>
        </div>
      </div>

      <div class="row">
        <div class="col-md-12">
          <h2 class="sectiontitle">Dessert</h2>
        </div>
      </div> -->
