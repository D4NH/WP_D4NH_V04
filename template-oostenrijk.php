<?php /* Template Name: Oostenrijk Template */ get_header(); ?>
      ...
      <div id="intro" class="container">
        <div class="row intro">
          <div class="col-md-offset-3 col-md-6">
            <?php
              // The Query
              $the_query = new WP_Query( array( 'page_id' => 1719 ) );
        ...
        <div class="row intro">
            ...
            <?php
              ...
              // The Query
              $the_query = new WP_Query( array( 'category_name' => 'oostenrijk-2016', 'posts_per_page' => -1 ) );
